      ...
      <div className='container mx-auto'>
        ...
        >
          ...
          <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
            ...
            Enjoy the simplicity of reserving your 
            ideal vehicle and specifying your duration, ensuring a stress-free rental process.
            </p>
          </div>
          {/* item 2 */}
          <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
            ...
            <p className='hidden xl:flex'>
            Our fleet boasts modern, meticulously maintained vehicles, offering a wide range of options to suit your needs. 
            </p>
          </div>
          {/* item 3 */}
          <div className='flex flex-col items-center text-center max-w-[160px] xl:max-w-none p-2 xl:p-0'>
            ...
            <p className='hidden xl:flex'>
            Count on our 24/7 support and flexibility. We're here for any assistance or changes, ensuring a reliable and convenient rental experience.
            </p>
          </div>
        </motion.div>
      </div>
